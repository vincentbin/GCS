package com.polyu.gcs.server.registry;
...
import com.polyu.gcs.server.connect.NettyPeerServerConnector;
...
public class RegistryCenter {
    ...
    public void registerService(String host, int port) throws Exception {
        ...
        try {
            ...
            logger.error("Register GCS fail, exception: {}.", e.getMessage(), e);
        }
            ...
            public void childEvent(CuratorFramework curatorFramework, PathChildrenCacheEvent pathChildrenCacheEvent) {
                ...
                switch (type) {
                    case CHILD_ADDED:
                        ...
                        NettyPeerServerConnector.connect(rpAdd.getHost(), rpAdd.getPort());
                        break;
                    case CHILD_REMOVED:
